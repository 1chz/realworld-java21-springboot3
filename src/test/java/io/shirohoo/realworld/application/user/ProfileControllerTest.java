...
class ProfileControllerTest {
    ...
    void setUp() throws Exception {
        userService.signUp(new SignUpRequest("james@example.com", "james", "password"));
        userService.signUp(new SignUpRequest("simpson@example.com", "simpson", "password"));
    }
    ...
    void getProfileOnAuthenticate() throws Exception {
        ...
        LoginRequest loginRequest = new LoginRequest("james@example.com", "password");
