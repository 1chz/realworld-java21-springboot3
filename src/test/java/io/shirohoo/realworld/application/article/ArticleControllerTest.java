package io.shirohoo.realworld.application.article;
...
class ArticleControllerTest {
    ...
    void setUp() throws Exception {
        SignUpRequest jamesSignUpRequest = new SignUpRequest("james@example.com", "james", "password");
        User james = userService.signUp(jamesSignUpRequest);

        SignUpRequest simpsonSignUpRequest = new SignUpRequest("simpson@example.com", "simpson", "password");
        ...
        LoginRequest jamesLoginRequest = new LoginRequest("james@example.com", "password");
        jamesToken = "Token " + userService.login(jamesLoginRequest).token();

        LoginRequest simpsonLoginRequest = new LoginRequest("simpson@example.com", "password");
