...
class SocialController {
    ...
    ProfilesResponse doGet(RealWorldAuthenticationToken jwt, @PathVariable("username") String targetUsername) {
    ...
    ProfilesResponse doPost(RealWorldAuthenticationToken jwt, @PathVariable("username") String targetUsername) {
    ...
    ProfilesResponse doDelete(RealWorldAuthenticationToken jwt, @PathVariable("username") String targetUsername) {
        var follower = userService.getUser(jwt.userId());
        var following = userService.getUser(targetUsername);
